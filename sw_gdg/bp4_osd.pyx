...
cdef class bp4_osd:
    ...
    cpdef np.ndarray[np.int64_t, ndim=2] decode(self, input_vector_x, input_vector_z):
    ...
    cpdef np.ndarray[np.int64_t, ndim=2] camel_decode(self, input_vector_x, input_vector_z):
        cdef int input_length_x = input_vector_x.shape[0]
        cdef int vn
